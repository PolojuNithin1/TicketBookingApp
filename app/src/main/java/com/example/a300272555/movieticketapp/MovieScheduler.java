...
// Admin Module Activity used by admin to schedule movies
    ...
    private int[] pictures = {R.drawable.cp1, R.drawable.cpp1,R.drawable.java1,R.drawable.python1,R.drawable.nodejs1, R.drawable.beauty_and_beast,R.drawable.dotnet1,R.drawable.fast_and_furious,R.drawable.php1,R.drawable.wordpress1,R.drawable.magento1,R.drawable.shopify1, R.drawable.wonderwoman,R.drawable.angular1,R.drawable.justice_league};
    private String[] names = {"Ek Mini Katha","Vakeel Saab","Bhahubali","Bigil","Dharbar", "Beauty and the Beast","Maharshi", "Fast and Furious", "Arjun Reddy","Krack","Bharath Ane Nenu","Rang De","WonderWoman","Bhahubali 2", "Justice League"};
    private userDB db;
    int flag=1;
...
// Buttons capture StartTime , RunTime , CleaningTime , Theatre Close Time selected by ADMIN
      ...
      /*  Button btnClean = (Button) findViewById(R.id.btnClean);
        ...
        Button btnbook=(Button) findViewById(R.id.button);
        btnbook.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentbook = new Intent(getApplicationContext(),Booked_Tickets.class);
                 ...
                 /*   for(int j=0;j<i;j++) {
                    ...
                    try {
                        ...
                        for (int j = 0; j < i; j++) {
                            ...
                            values.put(MovieDetailsEntry.COLUMN_NAME_Movie_BookedSeatNo, 0);
